...
\input{\modInputPrefix/out/303_dg_0_11100_f_0_1_filt_coord.tex}
% id = 0, graphName = g_{0}
...
\path[modStyleDGHyperConnector] (v-0-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1},\ Move}$} (v-5-0);
% id = 8{ 'g_{0}' }, 'Move', { 'p_{0,3}' }
% id = 9{ 'p_{0,0}' }, 'Jump', { 'g_{0}' }
% id = 10{ 'p_{0,1}' }, 'Jump', { 'g_{0}' }
% id = 12{ 'p_{0,2}' }, 'Jump', { 'p_{0,4}' }
% id = 14{ 'p_{0,2}' }, 'Jump', { 'p_{0,5}' }
\path[modStyleDGHyperConnector] (v-5-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0},\ Jump}$} (v-13-0);
...
\path[modStyleDGHyperConnector] (v-13-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1},\ Move}$} (v-38-0);
...
\path[modStyleDGHyperConnector] (v-38-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0},\ Jump}$} (v-50-0);
...
\path[modStyleDGHyperConnector] (v-50-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0},\ Jump}$} (v-64-0);
...
\path[modStyleDGHyperConnector] (v-64-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1},\ Move}$} (v-102-0);
...
\path[modStyleDGHyperConnector] (v-102-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0},\ Jump}$} (v-132-0);
...
\path[modStyleDGHyperConnector] (v-132-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0},\ Jump}$} (v-176-0);
...
\path[modStyleDGHyperConnector] (v-176-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0},\ Jump}$} (v-235-0);
...
\path[modStyleDGHyperConnector] (v-235-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1},\ Move}$} (v-326-0);
...
\path[modStyleDGHyperConnector] (v-326-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0},\ Jump}$} (v-372-0);
...
\path[modStyleDGHyperConnector] (v-372-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0},\ Jump}$} (v-417-0);
...
\path[modStyleDGHyperConnector] (v-417-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1},\ Move}$} (v-496-0);
...
\path[modStyleDGHyperConnector] (v-496-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0},\ Jump}$} (v-523-0);
...
\path[modStyleDGHyperConnector] (v-523-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1},\ Move}$} (v-557-0);
