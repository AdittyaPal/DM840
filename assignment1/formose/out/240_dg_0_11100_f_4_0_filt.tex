...
\input{\modInputPrefix/out/239_dg_0_11100_f_4_0_filt_coord.tex}
...
\path[modStyleDGHyperConnector] (v-11-0) to node[auto, swap] {$\mathrm{f\ 100,\ r_{1}}$} (v-10-0);
...
% inFlow/outFlow, id = 10-0, graphName = g_{10}, inFlow = 0, outFlow = 1
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-10-0-IOFlow)] (v-10-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-10-0) to node[auto, swap] {$\mathrm{f\ 1}$} (v-10-0-IOFlow);
\end{tikzpicture}%
