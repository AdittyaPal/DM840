...
\input{\modInputPrefix/out/222_dg_0_11100_f_2_2_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-92-0)] (v-92-0) {$\mathrm{f\ 1,\ r_{2}}$};
% id = 111{ 'Glycolaldehyde' 'p_{0,13}' }, 'Aldol Addition ->', { 'p_{0,5}' }
\node[modStyleDGHyperEdge, at=(v-coord-111-0)] (v-111-0) {$\mathrm{f\ 1,\ r_{2}}$};
% id = 216{ 'p_{0,28}' }, 'Aldol Addition <-', { 'g_{12}' 'p_{0,13}' }
\node[modStyleDGHyperEdge, at=(v-coord-216-0)] (v-216-0) {$\mathrm{f\ 1,\ r_{3}}$};
...
\path[modStyleDGHyperConnector] (v-91-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0}}$} (v-153-0);
...
\path[modStyleDGHyperConnector] (v-153-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1}}$} (v-97-0);
...
% inFlow/outFlow, id = 12-0, graphName = g_{12}, inFlow = 1, outFlow = 2
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-12-0-IOFlow)] (v-12-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-12-0-IOFlow) to[modStyleDGHyperHasReverseShortcut] node[auto, swap] {$\mathrm{f\ 1}$} (v-12-0);
\path[modStyleDGHyperConnector] (v-12-0) to[modStyleDGHyperHasReverseShortcut] node[auto, swap] {$\mathrm{f\ 2}$} (v-12-0-IOFlow);
\end{tikzpicture}%
