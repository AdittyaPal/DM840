...
\input{\modInputPrefix/out/212_dg_0_11100_f_1_0_filt_coord.tex}
...
\path[modStyleDGHyperConnector] (v-10-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0}}$} (v-11-0);
...
% inFlow/outFlow, id = 11-0, graphName = g_{11}, inFlow = 1, outFlow = 2
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-11-0-IOFlow)] (v-11-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-11-0-IOFlow) to[modStyleDGHyperHasReverseShortcut] node[auto, swap] {$\mathrm{f\ 1}$} (v-11-0);
\path[modStyleDGHyperConnector] (v-11-0) to[modStyleDGHyperHasReverseShortcut] node[auto, swap] {$\mathrm{f\ 2}$} (v-11-0-IOFlow);
\end{tikzpicture}%
