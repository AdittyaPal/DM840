...
\input{\modInputPrefix/out/251_dg_0_11100_f_7_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-54-0)] (v-54-0) {$\mathrm{f\ 1,\ r_{2}}$};
...
\path[modStyleDGHyperConnector] (v-12-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0}}$} (v-13-0);
...
\path[modStyleDGHyperConnector] (v-11-0) to node[auto, swap] {$\mathrm{f\ 99,\ r_{1}}$} (v-10-0);
% id = 30{ 'g_{11}' }, 'Keto-enol isomerization <-', { 'g_{12}' }
\path[modStyleDGHyperConnector] (v-11-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1}}$} (v-12-0);
...
\path[modStyleDGHyperConnector] (v-53-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0}}$} (v-83-0);
% id = 86{ 'p_{0,11}' }, 'Keto-enol isomerization ->', { 'p_{0,24}' }
% id = 87{ 'p_{0,14}' }, 'Keto-enol isomerization ->', { 'p_{0,13}' }
\path[modStyleDGHyperConnector] (v-65-0) to node[auto, swap] {$\mathrm{f\ 100,\ r_{0}}$} (v-63-0);
...
\path[modStyleDGHyperConnector] (v-99-0) to node[auto, swap] {$\mathrm{f\ 99,\ r_{0}}$} (v-163-0);
...
\path[modStyleDGHyperConnector] (v-83-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1}}$} (v-116-0);
...
\path[modStyleDGHyperConnector] (v-163-0) to node[auto, swap] {$\mathrm{f\ 99,\ r_{1}}$} (v-116-0);
...
\node[modStyleDGHyperVertexHiddenLarge, at=(v-coord-13-0-IOFlow)] (v-13-0-IOFlow) {};
\path[modStyleDGHyperConnector] (v-13-0) to node[auto, swap] {$\mathrm{f\ 1}$} (v-13-0-IOFlow);
\end{tikzpicture}%
