...
\input{\modInputPrefix/out/243_dg_0_11100_f_5_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-61-0)] (v-61-0) {$\mathrm{f\ 98,\ r_{2}}$};
% id = 100{ 'g_{10}' 'p_{0,13}' }, 'Aldol Addition ->', { 'p_{0,29}' }
\node[modStyleDGHyperEdge, at=(v-coord-100-0)] (v-100-0) {$\mathrm{f\ 99,\ r_{2}}$};
% id = 112{ 'p_{0,14}' 'p_{0,15}' }, 'Aldol Addition ->', { 'random5' }
\node[modStyleDGHyperEdge, at=(v-coord-112-0)] (v-112-0) {$\mathrm{f\ 1,\ r_{2}}$};
% id = 120{ 'random5' 'p_{0,15}' }, 'Aldol Addition ->', { 'p_{0,35}' }
\node[modStyleDGHyperEdge, at=(v-coord-120-0)] (v-120-0) {$\mathrm{f\ 1,\ r_{2}}$};
% id = 126{ 'g_{12}' 'p_{0,15}' }, 'Aldol Addition ->', { 'p_{0,38}' }
\node[modStyleDGHyperEdge, at=(v-coord-126-0)] (v-126-0) {$\mathrm{f\ 96,\ r_{2}}$};
% id = 139{ 'p_{0,0}' }, 'Aldol Addition <-', { 'Glycolaldehyde' 'g_{13}' }
\node[modStyleDGHyperEdge, at=(v-coord-139-0)] (v-139-0) {$\mathrm{f\ 96,\ r_{3}}$};
% id = 221{ 'p_{0,34}' }, 'Aldol Addition <-', { 'g_{11}' 'p_{0,14}' }
\node[modStyleDGHyperEdge, at=(v-coord-221-0)] (v-221-0) {$\mathrm{f\ 100,\ r_{3}}$};
% id = 226{ 'p_{0,39}' }, 'Aldol Addition <-', { 'g_{10}' 'p_{0,15}' }
\node[modStyleDGHyperEdge, at=(v-coord-226-0)] (v-226-0) {$\mathrm{f\ 98,\ r_{3}}$};
...
\path[modStyleDGHyperConnector] (v-11-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1}}$} (v-10-0);
% id = 30{ 'g_{11}' }, 'Keto-enol isomerization <-', { 'g_{12}' }
% id = 31{ 'g_{13}' }, 'Keto-enol isomerization <-', { 'g_{12}' }
\path[modStyleDGHyperConnector] (v-13-0) to node[auto, swap] {$\mathrm{f\ 96,\ r_{1}}$} (v-12-0);
...
\path[modStyleDGHyperConnector] (v-38-0) to node[auto, swap] {$\mathrm{f\ 98,\ r_{0}}$} (v-77-0);
...
\path[modStyleDGHyperConnector] (v-65-0) to node[auto, swap] {$\mathrm{f\ 99,\ r_{0}}$} (v-63-0);
...
\path[modStyleDGHyperConnector] (v-93-0) to node[auto, swap] {$\mathrm{f\ 98,\ r_{0}}$} (v-156-0);
...
\path[modStyleDGHyperConnector] (v-99-0) to node[auto, swap] {$\mathrm{f\ 100,\ r_{0}}$} (v-163-0);
...
\path[modStyleDGHyperConnector] (v-119-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0}}$} (v-165-0);
...
\path[modStyleDGHyperConnector] (v-125-0) to node[auto, swap] {$\mathrm{f\ 96,\ r_{0}}$} (v-71-0);
...
\path[modStyleDGHyperConnector] (v-71-0) to node[auto, swap] {$\mathrm{f\ 96,\ r_{1}}$} (v-32-0);
...
\path[modStyleDGHyperConnector] (v-77-0) to node[auto, swap] {$\mathrm{f\ 98,\ r_{1}}$} (v-93-0);
...
\path[modStyleDGHyperConnector] (v-156-0) to node[auto, swap] {$\mathrm{f\ 98,\ r_{1}}$} (v-127-0);
...
\path[modStyleDGHyperConnector] (v-163-0) to node[auto, swap] {$\mathrm{f\ 100,\ r_{1}}$} (v-116-0);
% id = 242{ 'p_{0,48}' }, 'Keto-enol isomerization <-', { 'p_{0,35}' }
% id = 243{ 'p_{0,48}' }, 'Keto-enol isomerization <-', { 'p_{0,29}' }
\path[modStyleDGHyperConnector] (v-165-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1}}$} (v-99-0);
...
\path[modStyleDGHyperConnector] (v-11-0) to node[auto, swap] {$\mathrm{f\ 1}$} (v-11-0-IOFlow);
\end{tikzpicture}%
