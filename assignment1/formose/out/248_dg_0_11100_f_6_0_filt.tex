...
\input{\modInputPrefix/out/247_dg_0_11100_f_6_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-67-0)] (v-67-0) {$\mathrm{f\ 1,\ r_{3}}$};
% id = 102{ 'Glycolaldehyde' 'p_{0,13}' }, 'Aldol Addition ->', { 'random2' }
\node[modStyleDGHyperEdge, at=(v-coord-102-0)] (v-102-0) {$\mathrm{f\ 2,\ r_{2}}$};
...
\path[modStyleDGHyperConnector] (v-5-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1}}$} (v-6-0);
...
\path[modStyleDGHyperConnector] (v-13-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1}}$} (v-12-0);
...
\path[modStyleDGHyperConnector] (v-65-0) to node[auto, swap] {$\mathrm{f\ 2,\ r_{0}}$} (v-63-0);
...
\path[modStyleDGHyperConnector] (v-12-0) to node[auto, swap] {$\mathrm{f\ 1}$} (v-12-0-IOFlow);
\end{tikzpicture}%
