...
\input{\modInputPrefix/out/219_dg_0_11100_f_2_1_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-56-0)] (v-56-0) {$\mathrm{f\ 1,\ r_{2}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-118-0)] (v-118-0) {$\mathrm{f\ 1,\ r_{2}}$};
% id = 149{ 'p_{0,10}' }, 'Aldol Addition <-', { 'g_{11}' 'p_{0,16}' }
\node[modStyleDGHyperEdge, at=(v-coord-149-0)] (v-149-0) {$\mathrm{f\ 1,\ r_{3}}$};
...
\path[modStyleDGHyperConnector] (v-7-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0}}$} (v-8-0);
