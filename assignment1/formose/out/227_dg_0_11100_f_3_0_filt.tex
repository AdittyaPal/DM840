...
\input{\modInputPrefix/out/226_dg_0_11100_f_3_0_filt_coord.tex}
...
\node[modStyleDGHyperEdge, at=(v-coord-62-0)] (v-62-0) {$\mathrm{f\ 1,\ r_{2}}$};
...
\node[modStyleDGHyperEdge, at=(v-coord-132-0)] (v-132-0) {$\mathrm{f\ 1,\ r_{2}}$};
% id = 220{ 'p_{0,33}' }, 'Aldol Addition <-', { 'g_{13}' 'p_{0,14}' }
\node[modStyleDGHyperEdge, at=(v-coord-220-0)] (v-220-0) {$\mathrm{f\ 1,\ r_{3}}$};
% id = 225{ 'p_{0,38}' }, 'Aldol Addition <-', { 'g_{12}' 'p_{0,15}' }
\node[modStyleDGHyperEdge, at=(v-coord-225-0)] (v-225-0) {$\mathrm{f\ 1,\ r_{3}}$};
...
\path[modStyleDGHyperConnector] (v-32-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0}}$} (v-71-0);
...
\path[modStyleDGHyperConnector] (v-65-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0}}$} (v-63-0);
...
\path[modStyleDGHyperConnector] (v-131-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{0}}$} (v-167-0);
...
\path[modStyleDGHyperConnector] (v-71-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1}}$} (v-125-0);
...
\path[modStyleDGHyperConnector] (v-167-0) to node[auto, swap] {$\mathrm{f\ 1,\ r_{1}}$} (v-113-0);
...
\path[modStyleDGHyperConnector] (v-13-0-IOFlow) to[modStyleDGHyperHasReverseShortcut] node[auto, swap] {$\mathrm{f\ 1}$} (v-13-0);
\path[modStyleDGHyperConnector] (v-13-0) to[modStyleDGHyperHasReverseShortcut] node[auto, swap] {$\mathrm{f\ 2}$} (v-13-0-IOFlow);
\end{tikzpicture}%
